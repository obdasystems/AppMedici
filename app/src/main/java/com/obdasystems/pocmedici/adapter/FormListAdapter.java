...
public class FormListAdapter
        extends RecyclerView.Adapter<FormListAdapter.MyViewHolder> {
    private Context mContext;
    //private List<Message> messages;
    private List<JoinFormWithMaxPageNumberData> forms;
    private FormListAdapter.FormAdapterListener listener;
    ...
    public FormListAdapter(Context mContext, List<JoinFormWithMaxPageNumberData> forms, FormListAdapter.FormAdapterListener listener) {
    ...
    @Override
    public FormListAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.form_list_row, parent, false);

        return new FormListAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final FormListAdapter.MyViewHolder holder, final int position) {
    ...
    private void applyClickEvents(FormListAdapter.MyViewHolder holder, final int position) {
    ...
    private void applyProfilePicture(FormListAdapter.MyViewHolder holder) {
        try {
    ...
    private void applyIconAnimation(FormListAdapter.MyViewHolder holder, int position) {
    ...
    /*private void applyImportant(FormListAdapter.DrugViewHolder holder, Message message) {
    ...
    /*private void applyReadStatus(FormListAdapter.DrugViewHolder holder, Message message) {
        if (message.isRead()) {
